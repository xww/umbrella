...
"""
Routines for configuring Umbrella
"""
...
paste_deploy_opts = [
    cfg.StrOpt('config_file', default='/etc/umbrella/umbrella.conf',
...
cpu_opts = [
    cfg.IntOpt("cpu_task_period", default=60,
               help=_("time period to gather vms network info, "
                      "unit is second")),
    cfg.IntOpt("cpu_task_times", default=5,
               help=_("in a period, total times to get info to static"))
]
disk_opts = [
    cfg.IntOpt("disk_task_period", default=60,
               help=_("time period to gather vms network info, "
                      "unit is second")),
    cfg.IntOpt("disk_task_times", default=5,
               help=_("in a period, total times to get info to static"))
]
mem_opts = [
    cfg.IntOpt("mem_task_period", default=60,
               help=_("time period to gather vms memory info, "
                      "unit is Mb")),
    cfg.IntOpt("mem_task_times", default=5,
               help=_("in a period, total times to get info to static"))
]
...
def load_paste_app(app_name, flavor=None, conf_file=None):
    ...
    try:
        ...
        app = deploy.loadapp("config:/etc/umbrella/umbrella-paste.ini",
                             name=app_name)
