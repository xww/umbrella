...
def define_disk_table(meta):
    net = Table('disk',
                   ...
                   Column('rd_req_rate', Integer()),
                   Column('rd_bytes_rate', Integer()),
                   Column('wr_req_rate', Integer()),
                   Column('wr_bytes_rate', Integer()),
